...
<div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
  ...
  >
    <span style={{ flex: 1 }}>Default toast</span>
  ...
  >
    <span style={{ flex: 1 }}>Success toast</span>
    <span aria-hidden>✕</span>
  </div>
  ...
  >
    <span style={{ flex: 1 }}>Error toast</span>
    <span aria-hidden>✕</span>
  </div>
  ...
  >
    <span style={{ flex: 1 }}>Warning toast</span>
    <span aria-hidden>✕</span>
  </div>
  ...
  >
    <span style={{ flex: 1 }}>Info toast</span>
    <span aria-hidden>✕</span>
  </div>
